    ...
    public partial class A_HT_OP : Form, IChildForm, IsetText, IBidCode
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dt2 = DBAdo.DtFillSql("SELECT CCODE,CNAME FROM ACLIENTS WHERE (SUBSTRING(CCODE,3,2)='" + ClassConstant.DW_ID.Substring(2) + "' OR CCODE LIKE '05%'  OR CCODE LIKE '01%') AND CCODE LIKE'" + dr[0].ToString() + ClassConstant.GetLeveLChar("LEVEL_KH", 1) + "'  ORDER BY CCODE");
                    ...
                    foreach (DataRow dr1 in dt2.Rows)
                    {
                        ...
                        DataTable dt3 = DBAdo.DtFillSql("SELECT CCODE,CNAME FROM ACLIENTS WHERE CCODE LIKE'" + dr1[0].ToString() + ClassConstant.GetLeveLChar("LEVEL_KH", 2) + "'  ORDER BY CCODE");
