...
namespace contract //AllocationRequest
{
    /// <summary>
    ...
    public static class Extensions
    {
            ...
            Graphics g, int pagewidth, int pageheight, Margins margins)
        {
            foreach (T t in list)
            {
                if (t.GetType() == typeof(ZYPrinter.ImbeddedImage))
                {
                    ZYPrinter.ImbeddedImage ii = (ZYPrinter.ImbeddedImage)Convert.ChangeType(t, typeof(ZYPrinter.ImbeddedImage));
    ...
    public class ZYPrinter
    {
        ...
        private void printcolumnheaders(Graphics g, ref float pos, PageDef pageset)
        {
            ...
            //lines.DashStyle = DashStyle.Solid;
            //-----------------------------------------------------------------
